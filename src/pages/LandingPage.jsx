    ...
    <div className="flex flex-col min-h-screen bg-gray-50 text-gray-800">
      ...
      <header className="w-full">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          {/* Website Title */}
          <div className="text-2xl font-bold text-primary">소개퐝</div>
          {/* Login and Sign Up Buttons */}
          <div className="flex items-center space-x-4">
            <button className="text-gray-600 hover:text-primary transition-colors duration-300 font-medium">
              로그인
            </button>
            <button className="bg-primary text-white px-5 py-2 rounded-lg shadow-md hover:bg-primary-dark transition-colors duration-300 font-medium">
              회원가입
            </button>
          </div>
        </nav>
